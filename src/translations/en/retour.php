...
return [
    ...
    'Should `no-cache` headers be set on the redirect response to prevent client-side caching?' => 'Should `no-cache` headers be set on the redirect response to prevent client-side caching?',
    'A Retour redirect with this Legacy URL already exists.' => 'A Retour redirect with this Legacy URL already exists.',
    'Advanced' => 'Advanced',
    'Set No-Cache Headers' => 'Set No-Cache Headers',
    '{attribute} is invalid.' => '{attribute} is invalid.',
    'Should Craft sites factor into determining redirect destination URLs.' => 'Should Craft sites factor into determining redirect destination URLs.',
    'General' => 'General',
    'A Retour redirect with this URL already exists.' => 'A Retour redirect with this URL already exists.',
    'Statistics' => 'Statistics',
    'A Short Link with this URL already exists.' => 'A Short Link with this URL already exists.',
    'Resolve Craft Sites' => 'Resolve Craft Sites',
];
